...
DEFAULTS = {
    ...
    "Lub oil pressure": (3.16,  "kPa",   0.86,  0.05),
    "Fuel pressure":    (6.20,  "kPa",   1.41,  0.05),
    "Coolant pressure": (2.17,  "kPa",   0.72,  0.05),
...
def sensor_slider(feat):
    ...
    with c2:
        st.number_input(
            "number", lo, hi,
            key=number_key, step=0.01, format="%.2f",   # counter stays fine-grained
